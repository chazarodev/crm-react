...
const Formulario = ({cliente, cargando}) => {
    ...
    const nuevoClienteSchema = Yup.object().shape({
        nombre: Yup.string().min(3, 'Nombre muy corto').max(20, 'Nombre muy extenso').required('El nombre del cliente es obligatorio'),
        empresa: Yup.string().required('Nombre de la Empresa es Obligatorio'),
        email: Yup.string().email('No es un Email válido').required('Email es Obligatorio'),
